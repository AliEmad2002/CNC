...
#define ROTARY_A_PIN						GPIO_Pin_A0
#define ROTARY_B_PIN						GPIO_Pin_A0

#define TFT_SPI_UNIT_NUMBER					SPI_UnitNumber_1
#define TFT_SPI_AFIO_MAP					0
#define TFT_RST_PIN							GPIO_Pin_A0
#define TFT_A0_PIN							GPIO_Pin_A0
